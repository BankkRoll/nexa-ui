try {
    ...
    var ct = Object.create,
        ...
        le = (e, t) =>
            function () {
                return (
                    t || (0, e[Ye(e)[0]])((t = { exports: {} }).exports, t),
                    t.exports
                );
            },
        mt = (e, t) => {
            ...
            if (Array.isArray(r)) {
                let n = t.arrayMaxProperties,
                    o = r
                        .slice(0, n)
                        .map((u, s) =>
                            a.createElement(U, { key: s, object: u }),
                        );
                r.length > n &&
                    o.push(
            ...
            return a.createElement(
                ...
                t &&
                    a.createElement(
                        Pt,
                        null,
                        a.createElement(Bt, { sortAscending: e }),
                    ),
            );
        },
        Ft = ({
    ...
    function gr(e, t) {
        ...
        var r = C(t);
        return w(
            v({}, r, { saturation: B(0, 1, r.saturation - parseFloat(e)) }),
        );
    }
    var ol = R(gr);
    function hr(e, t) {
    ...
    function Cr(e, t) {
        return t === 'transparent'
            ? t
            : it(parseFloat(e), 'rgb(255, 255, 255)', t);
    }
    var fl = R(Cr);
    function wr(e, t) {
        if (t === 'transparent') return t;
        ...
        return (
            ...
            a.createElement(
                ...
                a.createElement(
                    ...
                    e === 0
                        ? ''
                        : a.createElement(Fe, { status: 'neutral' }, e),
                ),
            )
        );
    }
    re.register(L, (e) => {
        re.add(Ce, {
            ...
            type: De.PANEL,
            render: ({ active: t }) =>
                a.createElement(Fr, { api: e, active: !!t }),
            paramKey: Se,
        });
    });
} catch (e) {
