try {
    ...
    var sa = b((ia, Kr) => {
        ...
        (function (e) {
            ...
            return (function n(o, a, c) {
                ...
                for (
                    var p = typeof Et == 'function' && Et, f = 0;
                    f < c.length;
                    f++
                )
                    l(c[f]);
                            ...
                            (c.prototype.get = function (l) {
                                ...
                                (c.prototype.indexOf = function (l) {
                                    ...
                                    for (p = 0; p < this.size; p++)
                                        if (this.isEqual(this.list[p].key, l))
                                            return p;
                                    return -1;
                                }),
    ...
    var Qt = b((OR, Va) => {
        ...
        var Wa = Ua(),
            ...
            bh = Wa(
                ...
                : function (e) {
                      return (
                          mh(e) && yh.call(e, 'callee') && !gh.call(e, 'callee')
                      );
                  };
        Va.exports = bh;
    });
    ...
    var Hs = b((N5, zs) => {
        ...
        function Gg(e, t, r, n, o, a, c) {
            switch (r) {
                ...
                case Ug:
                    return !(
                        e.byteLength != t.byteLength || !a(new ks(e), new ks(t))
                    );
                case qg:
                case Ng:
                case Mg:
    ...
    var fr = b((KB, lc) => {
        ...
        z.prototype = {
            then: function (e, t) {
                ...
                if (this._isResolved())
                    return z.resolve(this._data)._setParent(this);
    ...
    var Hc = b((P9, zc) => {
        ...
        zc.exports = function () {
            return (
                { __proto__: $c }.foo === $c.foo &&
                !({ __proto__: null } instanceof _v)
            );
        };
    });
    var Wc = b((N9, Uc) => {
    ...
    var vr = b((K9, Zc) => {
        ...
        var jn = function () {
            ...
            ze = {
                '%AggregateError%':
                    typeof AggregateError > 'u' ? L : AggregateError,
                '%Array%': Array,
                '%ArrayBuffer%': typeof ArrayBuffer > 'u' ? L : ArrayBuffer,
                '%ArrayIteratorPrototype%':
                    ot && X ? X([][Symbol.iterator]()) : L,
                ...
                '%BigInt64Array%':
                    typeof BigInt64Array > 'u' ? L : BigInt64Array,
                '%BigUint64Array%':
                    typeof BigUint64Array > 'u' ? L : BigUint64Array,
                '%Boolean%': Boolean,
    ...
    var lp = b((rq, up) => {
        ...
        up.exports = function (t, r) {
            var n = ip(t, !!r);
            return typeof n == 'function' && Hv(t, '.prototype.') > -1
                ? sp(n)
                : n;
        };
    });
    ...
    var Dp = b((pq, Tp) => {
        ...
        Tp.exports = function e(t, r, n, o) {
            ...
            if (d1(t)) {
                for (
                    ...
                    I +=
                        ' ' + O[R].name + '=' + _p(Zv(O[R].value), 'double', a);
                return (
                    (I += '>'),
            ...
            if (t1(t)) {
                ...
                return !('cause' in Error.prototype) &&
                    ...
                    ? '{ [' +
                          String(t) +
                          '] ' +
                          Ee.call(mp.call('[cause]: ' + v(t.cause), j), ', ') +
                          ' }'
                    : j.length === 0
                    ? '[' + String(t) + ']'
                    : '{ [' + String(t) + '] ' + Ee.call(j, ', ') + ' }';
            ...
            if (typeof t == 'object' && c) {
                if (vp && typeof t[vp] == 'function' && Wn)
                    return Wn(t, { depth: g - n });
        ...
        function h1(e) {
            ...
            return r
                ? '\\' + r
                : '\\x' + (t < 16 ? '0' : '') + Jv.call(t.toString(16));
        }
        function qt(e) {
            return 'Object(' + e + ')';
        }
...
` +
            ...
            var t,
                ...
                o = {
                    assert: function (a) {
                        if (!o.has(a))
                            throw new b1(
                                'Side channel does not contain ' + g1(a),
                            );
                    },
                    get: function (a) {
                        if (
        ...
        var Lp = Pp(),
            ...
            W1 = function e(t, r, n, o, a, c, l, p, f, g, E, v, w, x, T, I) {
                ...
                if (U1(O) || Rr.isBuffer(O)) {
                    if (l) {
                        ...
                        return [
                            w(K) + '=' + w(l(O, re.encoder, T, 'value', v)),
                        ];
                    }
            ...
            G1 = function (t) {
                ...
                var o = Lt.formatters[n],
                    a = re.filter;
                return (
                    (typeof t.filter == 'function' || xe(t.filter)) &&
                        (a = t.filter),
                    {
                        addQueryPrefix:
                        ...
                        delimiter:
                            typeof t.delimiter > 'u'
                                ...
                                : t.delimiter,
                        encode:
                            typeof t.encode == 'boolean' ? t.encode : re.encode,
                        encoder:
                            typeof t.encoder == 'function'
                                ? t.encoder
                                : re.encoder,
    ...
    var Up = b((Fq, Hp) => {
        ...
        var pt = to(),
            ...
            eA = function (t) {
                ...
                return {
                    allowDots:
                        typeof t.allowDots > 'u' ? J.allowDots : !!t.allowDots,
                    allowPrototypes:
                    ...
                    decoder:
                        typeof t.decoder == 'function' ? t.decoder : J.decoder,
                    delimiter:
                        typeof t.delimiter == 'string' ||
                        pt.isRegExp(t.delimiter)
                            ? t.delimiter
                            : J.delimiter,
                    depth:
    ...
    var Df = Object.create,
        ...
        le = (e, t) =>
            function () {
                return (
                    t || (0, e[Io(e)[0]])((t = { exports: {} }).exports, t),
                    t.exports
                );
            },
        Bf = (e, t, r, n) => {
    ...
    var nd = Object.create,
        ...
        ye = (e, t) =>
            function () {
                return (
                    t || (0, e[na(e)[0]])((t = { exports: {} }).exports, t),
                    t.exports
                );
            },
        sd = (e, t, r, n) => {
                ...
                (e.isEqual = (function () {
                    ...
                    return function (o, a) {
                        return (function c(l, p, f) {
                            ...
                            if (f.indexOf(l) > -1 && f.indexOf(p) > -1)
                                return !0;
                            if (
                                (f.push(l, p),
                                w != x ||
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                ...
                function de(A, S, _) {
                    ...
                    function bf(he, we) {
                        (we > C && P) ||
                            ((P = !1), (A = A.replace(he.pattern, he.sub)));
                    }
                    var Ro = [],
                        Ef = A,
                        bt = Ef.length;
    ...
    function $A(e, t) {
        ...
        var r = Be(t);
        return qe(
            ne({}, r, { lightness: ht(0, 1, r.lightness - parseFloat(e)) }),
        );
    }
    var aj = ce($A);
    function zA(e, t) {
    ...
    function QA(e, t) {
        return t === 'transparent'
            ? t
            : tf(parseFloat(e), 'rgb(255, 255, 255)', t);
    }
    var hj = ce(QA);
    function ZA(e, t) {
        if (t === 'transparent') return t;
                    ...
                    if (Object.getOwnPropertySymbols) {
                        ...
                        c &&
                            (p = p.filter(function (f) {
                                return Object.getOwnPropertyDescriptor(a, f)
                                    .enumerable;
                            })),
                            l.push.apply(l, p);
                    }
    ...
    function Ao(e) {
        ...
        if (e)
            if (typeof e == 'object')
                ...
                typeof e != 'boolean' && !e.call && (n && (n += ' '), (n += e));
        return n;
    }
    function Se() {
    ...
    var _o = (e) =>
        ...
        Ir = (e) => {
            let {
                ...
                g = (0, DS.default)(e, PS),
                { themeClass: E, currentTheme: v } = qr(
            ...
            let T = (C) => {
                ...
                B = (C, D) => {
                    ...
                    (C.key === 'Enter' || C.key === ' ') && T(!w),
                        C.key === 'ArrowRight' && w && !D
                            ? K(F, 'down')
                            : C.key === 'ArrowRight' && T(!0),
                        C.key === 'ArrowLeft' && (!w || D)
                            ? j(F)
                            : C.key === 'ArrowLeft' && T(!1),
            ...
            if (!I)
                return d.createElement(
                    'li',
                    (0, mo.default)(
                        { role: 'treeitem', className: ie.item },
                        g,
                    ),
                    d.createElement(
                        'div',
            ...
            return d.createElement(
                ...
                d.createElement(
                    'ul',
                    (0, mo.default)(
                        { role: 'group', className: Se(c, ie.group) },
                        g,
                    ),
                    w &&
                        d.Children.map(o, (C) =>
            ...
            return t.type === 'array'
                ...
                ? d.createElement(
                      ...
                      f === 'chrome' &&
                          d.createElement(
                              'span',
                              { className: W.functionDecorator },
                              '\u0192 ',
                          ),
                      d.createElement(
                          'span',
                          { className: Se({ [W.function]: !g }) },
                          `${t.value.name}()`,
                      ),
                  )
                : t.type === 'promise'
        ...
        hf = (e) => {
            ...
            return (
                ...
                d.createElement(
                    'div',
                    (0, wS.default)(
                        { className: Se(W.objectInspector, a, v) },
                        f,
                    ),
                    g &&
                        d.createElement(
                ...
                t.flatMap((r, n) => {
                    if (r.startsWith('expect(')) {
                        let f = sf(r, 7),
                            ...
                            E =
                                f &&
                                r.slice(g).match(/\.(to|last|nth)[A-Z]\w+\(/);
                        if (E) {
