...
`,
    ...
    var u = (function (e) {
        ...
        function t(r) {
            for (
                ...
                o[i - 1] = arguments[i];
            return (
                (a = e.call(this, se.apply(void 0, [ie[r]].concat(o))) || this),
                re(a)
            );
        }
        return t;
    ...
    function T(e) {
        ...
        var o = ge.exec(t.substring(0, 50));
        if (o)
            return {
                red: parseInt('' + o[1], 10),
    ...
    function xe(e, t, r) {
        ...
        if (typeof e == 'object' && t === void 0 && r === void 0)
            return P(e.hue, e.saturation, e.lightness);
        throw new u(1);
    }
    function Fe(e, t, r, a) {
        if (
    ...
    function $(e, t, r) {
        if (
            ...
            return H('#' + b(e) + b(t) + b(r));
        if (typeof e == 'object' && t === void 0 && r === void 0)
            return H('#' + b(e.red) + b(e.green) + b(e.blue));
        throw new u(6);
    }
    function S(e, t, r, a) {
    ...
    function Be(e, t) {
        ...
        var r = T(t),
            ...
            n = v({}, r, {
                alpha: j(0, 1, (a * 100 + parseFloat(e) * 100) / 100),
            });
        return S(n);
    }
    var Gt = I(Be);
    ...
    var V = q({
        base: 'dark',
        brandTitle: 'nexa-ui',
        brandUrl: 'https://github.com/BankkRoll/nexa-ui',
        brandImage: './logo.png',
    });
    G.setConfig({ theme: V });
} catch (e) {
