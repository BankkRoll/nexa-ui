        ...
        (function (t, e) {
            ...
            return (function (e) {
                ...
                function (e, n, r) {
                    ...
                    var o = {
                        ...
                        easeInSine: function (i, a, s, l) {
                            var u = s - a;
                            return (
                                -u * Math.cos((i / l) * (Math.PI / 2)) + u + a
                            );
                        },
                        easeOutSine: function (i, a, s, l) {
                            return (
                                (s - a) * Math.sin((i / l) * (Math.PI / 2)) + a
                            );
                        },
                        easeInOutSine: function (i, a, s, l) {
                            return (
                                (-(s - a) / 2) *
                                    (Math.cos((Math.PI * i) / l) - 1) +
                                a
                            );
                        },
                        ...
                        easeInCirc: function (i, a, s, l) {
                            return (
                                -(s - a) * (Math.sqrt(1 - (i /= l) * i) - 1) + a
                            );
                        },
                        easeOutCirc: function (i, a, s, l) {
                            return (
                                (s - a) * Math.sqrt(1 - (i = i / l - 1) * i) + a
                            );
                        },
                        ...
                        easeOutBounce: function (i, a, s, l) {
                            ...
                            return (i /= l) < 0.36363636363636365
                                ...
                                ? u *
                                      (7.5625 * (i -= 0.5454545454545454) * i +
                                          0.75) +
                                  a
                                : i < 0.9090909090909091
                                ? u *
                                      (7.5625 * (i -= 0.8181818181818182) * i +
                                          0.9375) +
                                  a
                                : u *
                                      (7.5625 * (i -= 0.9545454545454546) * i +
                                          0.984375) +
                                  a;
                        },
                        easeInOutBounce: function (i, a, s, l) {
                            ...
                            return i < l / 2
                                ...
                                : 0.5 * o.easeOutBounce(2 * i - l, 0, u, l) +
                                      0.5 * u +
                                      a;
                        },
                    };
                ...
                function (e, n, r) {
                    ...
                    var w = {
                            width:
                                typeof window < 'u' ? window.innerWidth : 300,
                            height:
                                typeof window < 'u' ? window.innerHeight : 200,
                            numberOfPieces: 200,
                            friction: 0.99,
                            wind: 0,
                            gravity: 0.1,
                            ...
                            function P($, Q) {
                                ...
                                (function (lt, ot) {
                                    ...
                                    b(this, 'reset', function () {
                                        V.generator &&
                                            V.generator.particlesGenerated >
                                                0 &&
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                    ...
                    function ht(P, T) {
                        ...
                        for (var k = 0, C = new Array(T); k < T; k++)
                            C[k] = P[k];
                        return C;
                    }
                    function Tt(P, T) {
    ...
    function Lt(t, e) {
        ...
        if (t && Ca(t) && e && Ca(e)) {
            ...
            for (var o = n.length; o-- !== 0; ) {
                var i = n[o];
                if (!(i === '_owner' && t.$$typeof) && !Lt(t[i], e[i]))
                    return !1;
            }
            return !0;
        }
        ...
        Ss = v(() => {
            jy(),
                ...
                (L.iterable = function (t) {
                    return (
                        !L.nullOrUndefined(t) && L.function(t[Symbol.iterator])
                    );
                }),
                (L.map = Xt('Map')),
                (L.nan = function (t) {
                ...
                (L.numericString = function (t) {
                    return (
                        L.string(t) && t.length > 0 && !Number.isNaN(Number(t))
                    );
                }),
                (L.object = function (t) {
                    return (
                        !L.nullOrUndefined(t) &&
                        (L.function(t) || typeof t == 'object')
                    );
                }),
    ...
    function zy(t, e, n) {
        return xf(t, e)
            ? [t, e].every(F.array)
                ...
                ? !Object.entries(t).some(du(n)) &&
                  Object.entries(e).some(du(n))
                : e === n
            : !1;
    }
    function cu(t, e, n) {
        ...
        Ky = ee((t) => {
            ...
            (t.AsyncMode = u),
                ...
                (t.isElement = function (S) {
                    return (
                        typeof S == 'object' && S !== null && S.$$typeof === n
                    );
                }),
    ...
    function t0(t) {
        ...
        return e === 'BODY'
            ? !1
            : e === 'HTML' || Rn(t.firstElementChild) === t;
    }
    function Aa(t) {
    ...
    function gu(t, e, n, r) {
        return Math.max(
            ...
            Fn(10)
                ? parseInt(n['offset' + t]) +
                      parseInt(
                          r['margin' + (t === 'Height' ? 'Top' : 'Left')],
                      ) +
                      parseInt(
                          r['margin' + (t === 'Height' ? 'Bottom' : 'Right')],
                      )
                : 0,
        );
    }
    ...
    function O0(t, e) {
        ...
        return (
            u.forEach(function (p) {
                var d =
                    ['left', 'top'].indexOf(p) !== -1 ? 'primary' : 'secondary';
                c = Ut({}, c, f[d](p));
            }),
            (t.offsets.popper = c),
            t
            ...
            (un =
                ...
                (Hf = (function () {
                    for (
                        ...
                        if (un && navigator.userAgent.indexOf(t[e]) >= 0)
                            return 1;
                    return 0;
                })()),
                                ...
                                value: function () {
                                    ...
                                    return (
                                        o
                                            ...
                                            : (u.content = g.createElement(
                                                  zi,
                                                  this.props,
                                              )),
                                        l === J.OPEN &&
                                            c.push('__floater__open'),
                                        a ||
                                            (u.arrow = g.createElement(
                                                Vi,
                                                this.props,
                                            )),
                                        g.createElement(
                ...
                function o() {
                    ...
                    me(this, o),
                        ...
                        H(this, 'update', function (p) {
                            if (!z0(p, Va))
                                throw new Error(
                                    'State is not valid. Valid keys: '.concat(
                                        Va.join(', '),
                                    ),
                                );
                            i.setState(
    ...
    function K0(t) {
        ...
        return new Promise(function (r, o) {
            ...
            Kf.default.top(e, t, { duration: a < 100 ? 50 : n }, function (s) {
                return s &&
                    s.message !== 'Element already at target scroll position'
                    ? o(s)
                    : r();
            });
        });
    ...
    function nr(t, e) {
        ...
        return (
            ...
            t.placementBeacon &&
                (i.wrapperOptions.placement = t.placementBeacon),
            o && (i.options.preventOverflow.boundariesElement = 'window'),
            D(
                D({}, n),
                {},
                {
                    locale: Me.default.all([
                        po.locale,
                        e.locale || {},
                        n.locale || {},
                    ]),
            ...
            Of(),
                ...
                Q0(function (t, e, n, r, o) {
                    ...
                    if (
                        ...
                        [pn.Element, pn.ForwardRef].indexOf(
                            (0, pn.typeOf)(a),
                        ) === -1
                    )
                        return new Error(
                            'Invalid '
                                ...
                                .concat(
                                    n,
                                    '`. Expected a React class or forwardRef.',
                                ),
                        );
                }),
                (Jf = {
                        ...
                        return (
                            ...
                            H(pt(r), 'handleMouseMove', function (s) {
                                var l = r.state.mouseOverSpotlight,
                                    ...
                                    b = x && E;
                                b !== l &&
                                    r.updateState({ mouseOverSpotlight: b });
                            }),
        ...
        return g.createElement(za, {
            ...
            styles: {
                ...
                options: {
                    ...
                    arrowColor:
                        s.base === 'dark' ? '#292A2C' : s.color.lightest,
                },
            },
        });
    }
            ...
            Vn(),
                ...
                (Pd = ct((t, e) => {
                    ...
                    let {
                        ...
                        S = Ob((N) => {
                            let B = N.target,
                                X = [...c.branches].some((et) =>
                                    et.contains(B),
                                );
                            !O ||
                                X ||
                                (i?.(N), s?.(N), N.defaultPrevented || l?.());
                        }, d),
                        M = Sb((N) => {
                            let B = N.target;
                    ...
                    return (
                                    ...
                                    r &&
                                        (c
                                            ...
                                            (d.body.style.pointerEvents =
                                                'none')),
                                        c.layersWithOutsidePointerEventsDisabled.add(
                                            f,
                                        )),
                                    c.layers.add(f),
                                    ac(),
                        ...
                        W(
                            () => () => {
                                f &&
                                    (c.layers.delete(f),
                                    c.layersWithOutsidePointerEventsDisabled.delete(
                                        f,
                                    ),
                                    ac());
                            },
        ...
        Db = v(() => {
            Vn(),
                ...
                (Cd = ct((t, e) => {
                    ...
                    return q(
                        De.div,
                        Ot({ tabIndex: -1 }, a, { ref: p, onKeyDown: h }),
                    );
                })),
                (Gi = Rb());
        }),
...
`),
  ...
  `,
                ...
                (ih = g.forwardRef(
                    ({ width: t, height: e, children: n, ...r }, o) =>
                        g.createElement(
                            $d,
                            { ref: o, asChild: !0, ...r },
...
`;
    ...
    var qa,
        ...
        Eh = v(() => {
            (Gc = 'production'),
                (js =
                    typeof process > 'u' || re === void 0 ? Gc : 'production');
        });
    function P1(t) {
        for (var e in t)
            t[e] !== null &&
    ...
    function ai(t) {
        var e;
        return (
            typeof ((e = t.animate) === null || e === void 0
                ? void 0
                : e.start) == 'function' ||
            Jt(t.initial) ||
            Jt(t.animate) ||
            ...
            return (
                !f.isStatic &&
                    ...
                    G1(
                        ...
                        l,
                        d.visualElement,
                        r || Dn.projectionNodeConstructor,
                    ),
    ...
    var Xs,
        ...
        ui = v(() => {
            Fe(),
                ...
                (Tn = Object.assign(Object.assign({}, Ie), {
                    transform: Xs(0, 1),
                })),
        ...
        qh = v(() => {
            Fe(),
                (dn = (t) => ({
                    test: (e) =>
                        kr(e) && e.endsWith(t) && e.split(' ').length === 1,
                    parse: parseFloat,
                    transform: (e) => `${e}${t}`,
                })),
                (ge = dn('deg')),
    ...
    function lw(t) {
        ...
        return (
            ...
            kr(t) &&
            ((n =
                (e = t.match(Nn)) === null || e === void 0
                    ? void 0
                    : e.length) !== null && n !== void 0
                ? n
                : 0) +
                ((o =
                    (r = t.match(zo)) === null || r === void 0
                        ? void 0
    ...
    function tl(t, e, n, r) {
        ...
        for (var d in e) {
            ...
            if (zr(d)) {
                ...
                h !== ((o = m.default) !== null && o !== void 0 ? o : 0) &&
                    (p = !1);
    ...
    function mm(t, e, n, r) {
        ...
        for (var o in e.attrs)
            t.setAttribute(ll.has(o) ? o : sl(o), e.attrs[o]);
    }
    var vm = v(() => {
        pm(), dm(), hm();
    });
    ...
    function Hw(t) {
        ...
        Yo(o, 'pointerenter', e || r ? op(o, !0, e) : void 0, { passive: !e }),
            Yo(o, 'pointerleave', n || r ? op(o, !1, n) : void 0, {
                passive: !n,
            });
    }
    var Ww = v(() => {
    ...
    function xl(t) {
        ...
        function m() {
            let y = c ? -(c / 1e3) : 0,
                ...
                b = Math.sqrt(s / u) / 1e3;
            if (
                (o === void 0 && (o = Math.min(Math.abs(n - e) / 100, 0.4)),
                x < 1)
            ) {
                let w = ts(b, x);
                (d = (O) => {
        ...
        Ym = v(() => {
            mi(),
                ...
                (Ol = (t, e) => {
                    ...
                    return (s) => {
                        for (let l in a)
                            l !== 'alpha' && (a[l] = sp(o[l], i[l], s));
                        return (
                            (a.alpha = dt(o.alpha, i.alpha, s)), n.transform(a)
                        );
                    };
                });
        }),
    ...
    function kE(t) {
        ...
        var o = So.get(r),
            i = JSON.stringify(n);
        return (
            o[i] || (o[i] = new IntersectionObserver(gv, A({ root: e }, n))),
            o[i]
        );
    }
    function RE(t, e, n) {
    ...
    function Np(t, e, n) {
        return (
            e === void 0 && (e = 0), n === void 0 && (n = 0.01), fv(t, e) < n
        );
    }
    function Ip(t, e, n, r) {
        r === void 0 && (r = 0.5),
        ...
        if (a) {
            ...
            for (var s, l, u = 0; u < a; u++)
                (s = n[u]),
                    (l = s.projectionDelta),
                    ((i =
                        (o = s.instance) === null || o === void 0
                            ? void 0
                            : o.style) === null || i === void 0
                        ? void 0
                        : i.display) !== 'contents' &&
                        (r &&
                    ...
                    return (
                                    ...
                                    l = function (f, p) {
                                        ...
                                        (m &&
                                            ...
                                            r.visualElement.projection &&
                                                ((r.visualElement.projection.isAnimationBlocked =
                                                    !0),
                                                (r.visualElement.projection.target =
                                                    void 0)),
                                            se(function (x) {
                                                var b,
                                                    w,
                        ...
                        (t.prototype.cancel = function () {
                            ...
                            !r &&
                                ...
                                (this.openGlobalLock(),
                                (this.openGlobalLock = null)),
                                (n = this.visualElement.animationState) ===
                                    null ||
                                    n === void 0 ||
            ...
            if (ce(i)) t.addValue(o, i);
                ...
                if (t.hasValue(o)) {
                    ...
                    t.addValue(
                        o,
                        jn(
                            (r = t.getStaticValue(o)) !== null && r !== void 0
                                ? r
                                : i,
                        ),
                    );
                                            ...
                                            if (P)
                                                return (
                                                    (z = P.variantChildren) ===
                                                        ...
                                                        z.add(I),
                                                    function () {
                                                        return P.variantChildren.delete(
                                                            I,
                                                        );
                                                    }
                                                );
        ...
        Yx = v(() => {
            ig(),
                ...
                (ug = function (t, e, n, r) {
                    var o = zx(t, e, r);
                    return (
                        (e = o.target), (r = o.transitionEnd), Hx(t, e, n, r)
                    );
                });
        });
    function qx(t) {
            ...
            G(),
                ...
                (bs = {
                    ...
                    getBaseTarget: function (t, e) {
                        var n;
                        return (n = t.style) === null || n === void 0
                            ? void 0
                            : n[e];
                    },
            ...
            function a(s, l, u) {
                ...
                l === void 0 && (l = {}),
                    ...
                    (this.checkUpdateFailed = function () {
                        c.isUpdating &&
                            ((c.isUpdating = !1), c.clearAllSnapshots());
                    }),
            ...
            return (
                (a.prototype.addEventListener = function (s, l) {
                    return (
                        this.eventHandlers.has(s) ||
                            this.eventHandlers.set(s, new An()),
                ...
                (a.prototype.mount = function (s, l) {
                    ...
                    if ((l === void 0 && (l = !1), !this.instance)) {
                        (this.isSVG =
                            s instanceof SVGElement && s.tagName !== 'svg'),
                            (this.instance = s);
                        var f = this.options,
                            p = f.layoutId,
                            d = f.layout,
                                    ...
                                    function (E) {
                                        ...
                                        if (
                                            ...
                                            u.resumeFrom &&
                                                ((u.resumingFrom =
                                                    u.resumeFrom),
                                                (u.resumingFrom.resumingFrom =
                                                    void 0)),
                                                u.setAnimationOrigin(M, Ft);
                                            var St = A(
                                                A({}, Dl(et, 'layout')),
                                                { onPlay: ht, onComplete: Tt },
                                            );
                ...
                (a.prototype.willUpdate = function (s) {
                    var l, u, c;
                    if (
                        (s === void 0 && (s = !0), this.root.isUpdateBlocked())
                    ) {
                ...
                (a.prototype.didUpdate = function () {
                    ...
                    this.isUpdating &&
                        ...
                        this.potentialNodes.size &&
                            (this.potentialNodes.forEach(xO),
                ...
                (a.prototype.scheduleCheckAfterUnmount = function () {
                    ...
                    te.postRender(function () {
                        s.isLayoutDirty
                            ? s.root.didUpdate()
                            : s.root.checkUpdateFailed();
                    });
                }),
                (a.prototype.updateSnapshot = function () {
                    if (!(this.snapshot || !this.instance)) {
                        var s = this.measure(),
                            l = this.removeTransform(
                                this.removeElementScroll(s),
                            );
                        pf(l),
                            (this.snapshot = {
                                measured: s,
                ...
                (a.prototype.setOptions = function (s) {
                    ...
                    this.options = A(A(A({}, this.options), s), {
                        crossfade:
                            (l = s.crossfade) !== null && l !== void 0 ? l : !0,
                    });
                }),
                            ...
                            lf(h.x, s.x, O),
                                ...
                                u.relativeTarget &&
                                    ...
                                    (Tr(
                                        m,
                                        u.layout.actual,
                                        u.relativeParent.layout.actual,
                                    ),
                                    wO(
                                        u.relativeTarget,
                                        u.relativeTargetOrigin,
                ...
                (a.prototype.startAnimation = function (s) {
                    ...
                    this.notifyListeners('animationStart'),
                        (u = this.currentAnimation) === null ||
                            u === void 0 ||
                            u.stop(),
                        this.resumingFrom &&
                            ((c = this.resumingFrom.currentAnimation) ===
                                null ||
                                c === void 0 ||
                                c.stop()),
                        this.pendingAnimation &&
                        ...
                        (this.pendingAnimation = te.update(function () {
                            (On.hasAnimatedSinceResize = !0),
                                ...
                                l.resumingFrom &&
                                    (l.resumingFrom.currentAnimation =
                                        l.currentAnimation),
                ...
                (a.prototype.registerSharedNode = function (s, l) {
                    var u, c, f;
                    this.sharedNodes.has(s) ||
                        this.sharedNodes.set(s, new Sg());
                    var p = this.sharedNodes.get(s);
                    p.add(l),
                        l.promote({
                            transition:
                                (u = l.options.initialPromotionConfig) ===
                                    null || u === void 0
                                    ? void 0
                                    : u.transition,
                            preserveFollowOpacity:
                                (f =
                                    (c = l.options.initialPromotionConfig) ===
                                        null || c === void 0
                                        ? void 0
                                        : c.shouldPreserveFollowOpacity) ===
                                    null || f === void 0
                                    ? void 0
                                    : f.call(c, l),
                        });
                    ...
                    if (!this.projectionDelta || !this.layout || !y.target) {
                        ...
                        return (
                            this.options.layoutId &&
                                ((E.opacity =
                                    (u = this.latestValues.opacity) !== null &&
                                    u !== void 0
                                        ? u
                                        : 1),
                    ...
                    for (var S in Ar)
                        if (x[S] !== void 0) {
                            var M = Ar[S],
                                ...
                                X = N(x[S], y);
                            if (B)
                                for (var et = B.length, rt = 0; rt < et; rt++)
                                    h[B[rt]] = X;
                            else h[S] = X;
                        }
                    return (
                ...
                (Bg = ({ activeStep: t, data: e, width: n, filename: r }) => {
                    let [o, i] = at([]),
                        ...
                        s = (c) => {
                            ...
                            for (let p = 0; p < c; p++)
                                f -=
                                    a[p].current.getBoundingClientRect().height;
                            return f;
                        },
                        l = xt(() => {
                            let c = e.flatMap((f, p) => {
    ...
    function IO() {
        ...
        return (
            W(() => {
                (async () => {
                    try {
                        let n = (await (await fetch('/index.json')).json())
        ...
        return (
            W(() => {
                (async () => {
                    try {
                        let n =
                            (await (await fetch('/project.json')).json())
                                ?.language === 'javascript'
                                ? Zg
                                : $g;
                        e({ data: n, error: null });
            ...
            W(() => {
                ...
                t.setQueryParams({ onboarding: 'true' }),
                    u !== 'example-button--primary' &&
                        t.selectStory('example-button--primary', void 0, {
                            ref: void 0,
                        });
            }, []),
            e
