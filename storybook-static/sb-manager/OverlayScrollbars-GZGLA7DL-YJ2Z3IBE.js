...
var createCache = (t2, n2) => {
        ...
        return (t3, n3, i3) => {
            ...
            if (
                ...
                let _3 = {
                    ...
                    h3 = {
                        w: Rt(
                            (p2 ? d2.innerWidth : f5.w + Rt(l3.w - e3.w)) +
                                o3.w,
                        ),
                        h: Rt(
                            (p2
                                ? d2.innerHeight + o3.h
                                : f5.h + Rt(l3.h - e3.h)) + o3.h,
                        ),
                    };
    ...
    createTrinsicObserver = (t2, n2) => {
        ...
        return [
            ...
            () => {
                if (o2)
                    return intersectionObserverCallback(o2.takeRecords(), !0);
            },
        ];
    },
    qt = `[${T}]`,
                ...
                () => {
                    ...
                    return (
                        n3 &&
                            assignDeep(
                                t3,
                                onHostMutation.apply(0, push(n3, !0)),
                            ),
                        o3 &&
                            assignDeep(
                                t3,
                                onTrinsicChanged.apply(0, push(o3, !0)),
                            ),
                        s3 &&
                            assignDeep(
                                t3,
                        ...
                        (h3 &&
                            ...
                            (c2 = createDOMObserver(
                                ...
                                onContentMutation,
                                {
                                    ...
                                    Mt: qt,
                                    kt: (t4, n4) => {
                                        let { target: o4, attributeName: s3 } =
                                            t4;
                                        return (
                                            (!n4 && s3 && !d2
                ...
                scrollbarsHandleStyle(t3, (t4) => {
                    ...
                    return [
                        s3,
                        {
                            [o3 ? 'width' : 'height']: `${(
                                100 *
                                getScrollbarHandleLengthRatio(s3, e3, o3, n3)
                            ).toFixed(3)}%`,
                        },
                    ];
                });
            ...
            [
                {
                    ...
                    nn: {
                        Kt: y2,
                        Qt: x2,
                        tn: scrollbarsHandleStyle.bind(0, y2),
                    },
                },
                appendElements,
        ...
        let e2,
            ...
            styleScrollbarPosition = (t3) => {
                ...
                return [
                    ...
                    {
                        transform: o3
                            ? `translate(${scrollLeft(z2)}px, ${scrollTop(
                                  z2,
                              )}px)`
                            : '',
                    },
                        ...
                        let {
                            ...
                            translateScrollbarsSetupElement = (t4) => {
                                ...
                                return assignDeep({}, s4, {
                                    clone: () => {
                                        let t5 = translateScrollbarStructure(
                                            o4(),
                                        );
                                        return p2({}, !0, {}), t5;
                                    },
            ...
            (0, import_react.useEffect)(() => {
                ...
                return (
                    I2 &&
                        ...
                        y2({
                            target: I2,
                            elements: { viewport: m2, content: m2 },
                        }),
                    () => {
                        var p2;
